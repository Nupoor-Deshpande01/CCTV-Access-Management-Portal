...
const Login = () => {
    ...
    const [role, setRole] = useState('citizen'); // 'citizen' or 'owner'
            ...
            <div className="login-left-pane">
                ...
                <div className="login-left-content">
                    <h1 className="login-headline">
                        Secure Access to <span>CCTV</span> <span>Footage</span>
                    </h1>
                    <p className="login-description">
                        The trusted platform for requesting and managing surveillance footage with privacy-first AI technology.
                    </p>
                </div>
            ...
            <div className="login-right-pane">
                <div className="login-card-wrapper">
                    ...
                    <div className="login-role-selector">
                        ...
                        <button
                            type="button"
                            className={`login-role-btn ${role === 'owner' ? 'active' : ''}`}
                    ...
                    {/* Note Banner */}
                    <div className="login-note-banner">
                        <span>Note:</span> Don't have an account? <Link to="/register">Sign up</Link> to get started.
                    </div>
